...
$data_testerapido = $registro["data_testerapido"];
...
$motivo_naorealizado_outro = $registro["motivo_naorealizado_outro"];
...
$desfecho = $_POST["desfecho"];
  ...
  // Cria comando SQL
$sql = "UPDATE gestantes SET uf_atendimento = '$uf_atendimento', 
                             muni_atendimento = '$muni_atendimento',
                             datainipre ='$datainipre',
                             data_diag ='$data_diag',
                             nome_unidade ='$nome_unidade',
                             num_area = '$num_area',
                             num_microarea ='$num_microarea',
                             nome_profissional = '$nome_profissional',
                             cns_prof = '$cns_prof',
                             nome_ag_comun ='$nome_ag_comun',
                             nome_gestante = '$nome_gestante',
                             data_nasc = '$data_nasc',
                             nome_mae = '$nome_mae',
                             estadocivil ='$estadocivil',
                             end_terceiro = '$end_terceiro',
                             racacor = '$racacor',
                             muni_residencia = '$muni_residencia',
                             uf_residencia = '$uf_residencia',
                             end_gestante = '$end_gestante',
                             ...
                             data_dum = '$data_dum',
                             data_dpp = '$data_dpp',
                             data_testerapido = '$data_testerapido',
                             result_testerapido = '$result_testerapido',
                             result_dose1 = '$result_dose1',
                             data_presc1 = '$data_presc1',
                             teste_trepo1 = '$teste_trepo1',
                             data_testetrepo1 = '$data_testetrepo1',
                             vrdl = '$vrdl',
                             data_lab = '$data_lab',
                             titulacao = '$titulacao',
                             teste_trepo2 = '$teste_trepo2',
                             data_testetrepo2 = '$data_testetrepo2',
                             treponemicoteste = '$treponemicoteste',
                             candroduro = '$candroduro',
                             localizacao = '$localizacao',
                             papulaspalmoplantares = '$papulaspalmoplantares',
                             alopecia = '$alopecia',
                             ausenciasinais = '$ausenciasinais',
                             aptneuro = '$aptneuro',
                             sifprimaria = '$sifprimaria',
                             sifprimaria_datadose = '$sifprimaria_datadose',
                             sifsecundaria = '$sifsecundaria',
                             sifsecundaria_datadose1 = '$sifsecundaria_datadose1',
                             sifsecundaria_datadose2 = '$sifsecundaria_datadose2',
                             sifterciaria = '$sifterciaria',
                             sifterciaria_datadose1 = '$sifterciaria_datadose1',
                             sifterciaria_datadose2 = '$sifterciaria_datadose2',
                             sifterciaria_datadose3 = '$sifterciaria_datadose3',
                             localdasdoses = '$localdasdoses',
                             gestalergica_penicilina = '$gestalergica_penicilina',
                             enc_dur = '$enc_dur',
                             presc_esquem_terapeutico = '$presc_esquem_terapeutico',
                             gest_infectadapre = '$gest_infectadapre',
                             tratamentoincompleto = '$tratamentoincompleto',
                             reiniciouesquema = '$reiniciouesquema',
                             enc_compulsoria = '$enc_compulsoria',
                             enc_compulsoria_data = '$enc_compulsoria_data',
                             parceirotratado = '$parceirotratado',
                             presc_outroesquema = '$presc_outroesquema',
                             esquema_prescparceiro = '$esquema_prescparceiro',
                             motivo_naorealizado = '$motivo_naorealizado',
                             motivo_naorealizado_outro = '$motivo_naorealizado_outro',
                             desfecho = '$desfecho' WHERE id = $id";
    ...
    <ul class="form-section page-section">
        ...
        <div id="cid_179" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" name="uf_atendimento" style="width:150px;" data-component="dropdown">
              ...
              <option <?php if ($uf_atendimento == "AC") echo "selected"; ?> value="AC"> AC </option>
              <option <?php if ($uf_atendimento == "AL") echo "selected"; ?> value="AL"> AL </option>
              <option <?php if ($uf_atendimento == "AM") echo "selected"; ?> value="AM"> AM </option> 
              <option <?php if ($uf_atendimento == "AP") echo "selected"; ?> value="AP"> AP </option>
              <option <?php if ($uf_atendimento == "BA") echo "selected"; ?> value="BA"> BA </option>
              <option <?php if ($uf_atendimento == "CE") echo "selected"; ?> value="CE"> CE </option>
              <option <?php if ($uf_atendimento == "DF") echo "selected"; ?> value="DF"> DF </option>
              <option <?php if ($uf_atendimento == "ES") echo "selected"; ?> value="ES"> ES </option>
              <option <?php if ($uf_atendimento == "GO") echo "selected"; ?> value="GO"> GO </option>
              <option <?php if ($uf_atendimento == "MA") echo "selected"; ?> value="MA"> MA </option>
              <option <?php if ($uf_atendimento == "MG") echo "selected"; ?> value="MG"> MG </option>
              <option <?php if ($uf_atendimento == "MS") echo "selected"; ?> value="MS"> MS </option>
              <option <?php if ($uf_atendimento == "MT") echo "selected"; ?> value="MT"> MT </option>
              <option <?php if ($uf_atendimento == "PA") echo "selected"; ?> value="PA"> PA </option>
              <option <?php if ($uf_atendimento == "PB") echo "selected"; ?> value="PB"> PB </option>
              <option <?php if ($uf_atendimento == "PE") echo "selected"; ?> value="PE"> PE </option>
              <option <?php if ($uf_atendimento == "PI") echo "selected"; ?> value="PI"> PI </option>
              <option <?php if ($uf_atendimento == "PR") echo "selected"; ?> value="PR"> PR </option>
              <option <?php if ($uf_atendimento == "RJ") echo "selected"; ?> value="RJ"> RJ </option>
              <option <?php if ($uf_atendimento == "RN") echo "selected"; ?> value="RN"> RN </option>
              <option <?php if ($uf_atendimento == "RO") echo "selected"; ?> value="RO"> RO </option>
              <option <?php if ($uf_atendimento == "RR") echo "selected"; ?> value="RR"> RR </option>
              <option <?php if ($uf_atendimento == "RS") echo "selected"; ?> value="RS"> RS </option>
              <option <?php if ($uf_atendimento == "SC") echo "selected"; ?> value="SC"> SC </option>
              <option <?php if ($uf_atendimento == "SE") echo "selected"; ?> value="SE"> SE </option>
              <option <?php if ($uf_atendimento == "SP") echo "selected"; ?> value="SP"> SP </option>
              <option <?php if ($uf_atendimento == "TO") echo "selected"; ?> value="TO"> TO </option>
            </select>
            <label class="form-label form-label-top" for="input_179" style="min-height:13px;"> UF </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_234">
        ...
        <div id="cid_234" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_234" name="muni_atendimento" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $muni_atendimento; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_234" style="min-height:13px;"> Município de Atendimento </label>
          </span>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_235">
        ...
        <div id="cid_235" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_235" name="nome_unidade" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $nome_unidade; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_235" style="min-height:13px;"> Nome da Unidade de Realização do Pré Natal </label>
          </span>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_232">
        ...
        <div id="cid_232" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_232" name="nome_profissional" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $nome_profissional; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_232" style="min-height:13px;"> Nome do Profissional de Saúde </label>
          </span>
        </div>
      </li>
        ...
        <label class="form-label form-label-top" id="label_237" for="lite_mode_237"> Data do Diagnóstico </label>
        <div id="cid_237" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_237" name="data_diag" type="date" style="font-size: 9px" size="15" data-maxlength="15" value="<?php echo $data_diag; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-2" data-type="control_datetime" id="id_236">
        <label class="form-label form-label-top" id="label_236" for="lite_mode_236"> Inicio do Pré Natal </label>
        <div id="cid_236" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="datainipre" id="lite_mode_236" style="font-size: 9px" type="date" size="15" data-maxlength="20" value="<?php echo $datainipre; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line" data-type="control_textbox" id="id_239">
        ...
        <div id="cid_239" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_239" name="nome_ag_comun" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $nome_ag_comun; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_239" style="min-height:13px;"> Nome do Agente Comunitário de Saúde </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_240">
        ...
        <div id="cid_240" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_240" name="num_area" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $num_area; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_240" style="min-height:13px;"> Numero da Área </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_233">
        ...
        <div id="cid_233" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_233" name="num_microarea" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $num_microarea; ?>"  data-component="textbox" />
            <label class="form-label form-label-top" for="input_233" style="min-height:13px;"> Numero da Micro área </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_175">
        ...
        <div id="cid_175" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_175" name="cns_prof" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $cns_prof; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_175" style="min-height:13px;"> CNS do Profissional de Saúde </label>
          </span>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_textbox" id="id_5">
        ...
        <div id="cid_5" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_5" name="nome_gestante" data-type="input-textbox" class="form-textbox" size="70" value="<?php echo $nome_gestante; ?>"  placeholder=" " data-component="textbox" />
            <label class="form-label form-label-top" for="input_5" style="min-height:13px;"> Nome da Gestante </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_238">
        <label class="form-label form-label-top" id="label_238" for="lite_mode_238"> Data de Nascimento </label>
        <div id="cid_238" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_nasc" id="lite_mode_238" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="<?php echo $data_nasc; ?>"  data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
        ...
        <div id="cid_177" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_177" name="estadocivil" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($estadocivil == "Solteira") echo "selected"; ?> value="Solteira"> Solteira </option>
              <option <?php if ($estadocivil == "Casada" ) echo "selected"; ?> value="Casada"> Casada </option>
              <option <?php if ($estadocivil == "Viúva" ) echo "selected"; ?> value="Viúva"> Viúva </option>
            </select>
            <label class="form-label form-label-top" for="input_177" style="min-height:13px;"> Estado Civil </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_181" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_181" name="end_terceiro" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($end_terceiro == "Convive com Companheiro e filhos") echo "selected"; ?> value="Convive com Companheiro e filhos"> Convive com Companheiro e filhos </option>
              <option <?php if ($end_terceiro == "Convive com Familiares") echo "selected"; ?> value="Convive com Familiares"> Convive com Familiares </option>
              <option <?php if ($end_terceiro == "Convive com Outras Pessoas") echo "selected"; ?> value="Convive com Outras Pessoas"> Convive com Outras Pessoas </option>
              <option <?php if ($end_terceiro == "Vive Só") echo "selected" ; ?> value="Vive Só"> Vive Só </option>
            </select>
            <label class="form-label form-label-top" for="input_181" style="min-height:13px;"> Com quem Mora </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_180" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_180" name="racacor" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($racacor == "Branco") echo "selected"; ?> value="Branco"> Branco </option>
              <option <?php if ($racacor == "Amarelo") echo "selected"; ?> value="Amarelo"> Amarelo </option>
              <option <?php if ($racacor == "Negro") echo "selected"; ?> value="Negro"> Negro </option>
              <option <?php if ($racacor == "Pardo") echo "selected"; ?> value="Pardo"> Pardo </option>
              <option <?php if ($racacor == "Indígena") echo "selected"; ?> value="Indígena"> Indígena </option>
            </select>
            <label class="form-label form-label-top" for="input_180" style="min-height:13px;"> Raça / Cor </label>
          </span>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_182">
        ...
        <div id="cid_182" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_182" name="nome_mae" data-type="input-textbox" class="form-textbox" size="70" value="<?php echo $nome_mae; ?>" placeholder=" " data-component="textbox" />
            <label class="form-label form-label-top" for="input_182" style="min-height:13px;"> Nome da Mãe </label>
          </span>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_241">
        ...
        <div id="cid_241" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_241" name="end_gestante" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $end_gestante; ?>"" data-component="textbox" />
            <label class="form-label form-label-top" for="input_241" style="min-height:13px;"> Logradouro (rua, avenida...) </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_179" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top;">
            <select class="form-dropdown" name="uf_residencia" style="width:150px;" data-component="dropdown">
              ...
              <option <?php if ($uf_residencia == "AC") echo "selected"; ?> value="AC"> AC </option>
              <option <?php if ($uf_residencia == "AL") echo "selected"; ?> value="AL"> AL </option>
              <option <?php if ($uf_residencia == "AM") echo "selected"; ?> value="AM"> AM </option> 
              <option <?php if ($uf_residencia == "AP") echo "selected"; ?> value="AP"> AP </option>
              <option <?php if ($uf_residencia == "BA") echo "selected"; ?> value="BA"> BA </option>
              <option <?php if ($uf_residencia == "CE") echo "selected"; ?> value="CE"> CE </option>
              <option <?php if ($uf_residencia == "DF") echo "selected"; ?> value="DF"> DF </option>
              <option <?php if ($uf_residencia == "ES") echo "selected"; ?> value="ES"> ES </option>
              <option <?php if ($uf_residencia == "GO") echo "selected"; ?> value="GO"> GO </option>
              <option <?php if ($uf_residencia == "MA") echo "selected"; ?> value="MA"> MA </option>
              <option <?php if ($uf_residencia == "MG") echo "selected"; ?> value="MG"> MG </option>
              <option <?php if ($uf_residencia == "MS") echo "selected"; ?> value="MS"> MS </option>
              <option <?php if ($uf_residencia == "MT") echo "selected"; ?> value="MT"> MT </option>
              <option <?php if ($uf_residencia == "PA") echo "selected"; ?> value="PA"> PA </option>
              <option <?php if ($uf_residencia == "PB") echo "selected"; ?> value="PB"> PB </option>
              <option <?php if ($uf_residencia == "PE") echo "selected"; ?> value="PE"> PE </option>
              <option <?php if ($uf_residencia == "PI") echo "selected"; ?> value="PI"> PI </option>
              <option <?php if ($uf_residencia == "PR") echo "selected"; ?> value="PR"> PR </option>
              <option <?php if ($uf_residencia == "RJ") echo "selected"; ?> value="RJ"> RJ </option>
              <option <?php if ($uf_residencia == "RN") echo "selected"; ?> value="RN"> RN </option>
              <option <?php if ($uf_residencia == "RO") echo "selected"; ?> value="RO"> RO </option>
              <option <?php if ($uf_residencia == "RR") echo "selected"; ?> value="RR"> RR </option>
              <option <?php if ($uf_residencia == "RS") echo "selected"; ?> value="RS"> RS </option>
              <option <?php if ($uf_residencia == "SC") echo "selected"; ?> value="SC"> SC </option>
              <option <?php if ($uf_residencia == "SE") echo "selected"; ?> value="SE"> SE </option>
              <option <?php if ($uf_residencia == "SP") echo "selected"; ?> value="SP"> SP </option>
              <option <?php if ($uf_residencia == "TO") echo "selected"; ?> value="TO"> TO </option>
            </select>
            <label class="form-label form-label-top" for="input_179" style="min-height:13px;"> UF </label>
          </span>
        </div>
      ...
      <li class="form-line" data-type="control_textbox" id="id_242">
        ...
        <div id="cid_242" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_242" name="muni_residencia" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $muni_residencia; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_242" style="min-height:13px;"> Município de Residência </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_243" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" name="num_residencia" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $num_residencia; ?>" maxlength="8" data-component="textbox" />
            <label class="form-label form-label-top" for="input_243" style="min-height:13px;"> Número </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_243">
        ...
        <div id="cid_243" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_243" name="complemento" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $complemento; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_243" style="min-height:13px;"> Complemento </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_244">
        ...
        <div id="cid_244" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_244" name="ref_ponto" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $ref_ponto; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_244" style="min-height:13px;"> Ponto de Referência </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_116">
        ...
        <div id="cid_116" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_116" name="telefone" data-type="input-textbox" class="form-textbox" size="15" value="<?php echo $telefone; ?>"  maxlength="15" placeholder=" " data-component="textbox" />
            <label class="form-label form-label-top" for="input_116" style="min-height:13px;"> Telefone Celular / Residencial </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_42" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_42" name="escolaridade" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($escolaridade == "Analfabeto") echo "selected";?> value="Analfabeto"> Analfabeto </option>
              <option <?php if ($escolaridade == "1° a 4° Série Incompleta do Ensino Fundamental") echo "selected"; ?> value="1° a 4° Série Incompleta do Ensino Fundamental"> 1° a 4° Série Incompleta do Ensino Fundamental </option>
              <option <?php if ($escolaridade == "4° Série Completa do ensino fundamental") echo "selected"; ?> value="4° Série Completa do ensino fundamental"> 4° Série Completa do ensino fundamental </option>
              <option <?php if ($escolaridade == "Ensino Fundamental Completo") echo "selected"; ?> value="Ensino Fundamental Completo"> Ensino Fundamental Completo </option>
              <option <?php if ($escolaridade == "Ensino Médio Incompleto") echo "selected"; ?> value="Ensino Médio Incompleto"> Ensino Médio Incompleto </option>
              <option <?php if ($escolaridade == "Ensino Médio Completo") echo "selected"; ?> value="Ensino Médio Completo"> Ensino Médio Completo </option>
              <option <?php if ($escolaridade == "Educação Superior Incompleta") echo "selected"; ?> value="Educação Superior Incompleta"> Educação Superior Incompleta </option>
              <option <?php if ($escolaridade == "Educação Superior completa") echo "selected"; ?> value="Educação Superior completa"> Educação Superior completa </option>
              <option <?php if ($escolaridade == "Ignorado") echo "selected"; ?> value="Ignorado"> Ignorado </option>
              <option <?php if ($escolaridade == "Não se Aplica") echo "selected"; ?> value="Não se Aplica"> Não se Aplica </option>
            </select>
            <label class="form-label form-label-top" for="input_42" style="min-height:13px;"> Escolaridade </label>
          </span>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_183">
        <label class="form-label form-label-top" id="label_183" for="lite_mode_183"> Data da DUM </label>
        <div id="cid_183" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_dum" id="lite_mode_183" type="date" size="15" data-maxlength="15" value="<?php echo $data_dum; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-2" data-type="control_datetime" id="id_184">
        <label class="form-label form-label-top" id="label_184" for="lite_mode_184"> Data da DPP </label>
        <div id="cid_184" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_dpp" id="lite_mode_184" type="date" size="15" data-maxlength="15" value="<?php echo $data_dpp; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_185">
        <label class="form-label form-label-top" id="label_185" for="lite_mode_185"> Data de Realização de teste Rápido para Sífilis </label>
        <div id="cid_185" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_testerapido" id="lite_mode_185" style="font-size: 9px" type="date" size="15" data-maxlength="15"  value="<?php echo $data_testerapido; ?>"  data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
        ...
        <div id="cid_186" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_186_0" name="result_testerapido" <?php if ($result_testerapido == "Negativo") echo "checked"; ?>  value="Negativo" />
              <label id="label_input_186_0" style="font-size: 9px" for="input_186_0"> Negativo </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_186_1" name="result_testerapido" <?php if ($result_testerapido == "Positivo") echo "checked"; ?> value="Positivo" />
              <label id="label_input_186_1" style="font-size: 9px" for="input_186_1"> Positivo </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_radio" id="id_167">
        <label class="form-label form-label-top" id="label_167" for="input_167"> Solicitado Teste não Treponêmico (VDRL) </label>
        <div id="cid_167" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_167_0" name="teste_trepo1" <?php if ($teste_trepo1 == "Sim") echo "checked"; ?>  value="Sim" />
              <label id="label_input_167_0" style="font-size: 9px" for="input_167_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_167_1" name="teste_trepo1" <?php if ($teste_trepo1 == "Não") echo "checked"; ?>  value="Não" />
              <label id="label_input_167_1" style="font-size: 9px" for="input_167_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_189">
        <label class="form-label form-label-top" id="label_189" for="lite_mode_189"> Data </label>
        <div id="cid_189" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="data_testetrepo1" value="<?php echo $data_testetrepo1; ?>" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_189" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line" data-type="control_radio" id="id_187">
        <label class="form-label form-label-top" id="label_187" for="input_187"> Prescrito tratamento com a 1° dose de Penicilina se TR Positivo </label>
        <div id="cid_187" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_187_0" name="result_dose1" <?php if ($result_dose1 == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_187_0" style="font-size: 9px" for="input_187_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_187_1" name="result_dose1" <?php if ($result_dose1 == "Não") echo "checked"; ?>  value="Não" />
              <label id="label_input_187_1" style="font-size: 9px" for="input_187_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_188">
        <label class="form-label form-label-top" id="label_188" for="lite_mode_188"> Data </label>
        <div id="cid_188" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="data_presc1" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_188" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="<?php echo $data_presc1; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
        ...
        <div id="cid_79" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_79" name="vrdl" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($vrdl == "Reagente") echo "selected"; ?> value="Reagente"> Reagente </option>
              <option <?php if ($vrdl == "Não Reagente") echo "selected"; ?> value="Não Reagente"> Não Reagente </option>
              <option <?php if ($vrdl == "Não Realizado") echo "selected"; ?> value="Não Realizado"> Não Realizado </option>
            </select>
            <label class="form-label form-label-top" for="input_79" style="min-height:13px;"> VDRL </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_117">
        ...
        <div id="cid_117" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="date" id="input_117" style="font-size: 9px" name="data_lab" data-type="input-textbox" class="form-textbox" size="15" value="<?php echo $data_lab; ?>" maxlength="15" placeholder=" " data-component="textbox" />
            <label class="form-label form-label-top" for="input_117" style="min-height:13px;"> Data </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_118">
        ...
        <div id="cid_118" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_118" name="titulacao" data-type="input-textbox" class="form-textbox" size="15" value="<?php echo $titulacao; ?>" maxlength="15" placeholder=" " data-component="textbox" />
            <label class="form-label form-label-top" for="input_118" style="min-height:13px;"> Titulação </label>
          </span>
        </div>
      </li>
      <li class="form-line" data-type="control_radio" id="id_190">
        <label class="form-label form-label-top" id="label_190" for="input_190"> Realizado teste treponêmico (FT A - abs TPH A ou MHA TP Elisa) </label>
        <div id="cid_190" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_190_0" name="teste_trepo2" <?php if ($teste_trepo2 == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_190_0" style="font-size: 9px" for="input_190_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_190_1" name="teste_trepo2" <?php if ($teste_trepo2 == "Não") echo "checked"; ?> value="Não" />
              <label id="label_input_190_1" style="font-size: 9px" for="input_190_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_191">
        ...
        <div id="cid_191" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="data_testetrepo2" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_191" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="<?php echo $data_testetrepo2; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
        ...
        <div id="cid_192" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_192_0" name="treponemicoteste" <?php if ($treponemicoteste == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_192_0" style="font-size: 9px" for="input_192_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_192_1" name="treponemicoteste" <?php if ($treponemicoteste == "Não") echo "checked"; ?> value="Não" />
              <label id="label_input_192_1" style="font-size: 9px" for="input_192_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
        ...
        <div id="cid_195" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_195" name="candroduro" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($candroduro == "Sim") echo "selected"; ?> value="Sim"> Sim </option>
              <option <?php if ($candroduro == "Não") echo "selected"; ?> value="Não"> Não </option>
            </select>
            <label class="form-label form-label-top" for="input_195" style="min-height:13px;"> Cancroduro </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_196" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_196" name="localizacao" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($localizacao == "Parede Vaginal") echo "selected"; ?> value="Parede Vaginal"> Parede Vaginal </option>
              <option <?php if ($localizacao == "Cérvix") echo "selected"; ?> value="Cérvix"> Cérvix </option>
              <option <?php if ($localizacao == "Períneo") echo "selected" ?> value="Períneo"> Períneo </option> 
            </select>
            <label class="form-label form-label-top" for="input_196" style="min-height:13px;"> Localização </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_198" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_198" name="papulaspalmoplantares" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($papulaspalmoplantares == "Sim") echo "selected"; ?> value="Sim"> Sim </option>
              <option <?php if ($papulaspalmoplantares == "Não") echo "selected" ?> value="Não"> Não </option>
            </select>
            <label class="form-label form-label-top" for="input_198" style="min-height:13px;"> Pápulas Palmo Plantares </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_199" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_199" name="alopecia" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($alopecia == "Sim") echo "selected"; ?> value="Sim"> Sim </option>
              <option <?php if ($alopecia == "Não") echo "selected"; ?> value="Não"> Não </option>
            </select>
            <label class="form-label form-label-top" for="input_199" style="min-height:13px;"> Alopécia </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_201" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_201" name="aptneuro" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($aptneuro == "Sim") echo "selected"; ?> value="Sim"> Sim </option>
              <option <?php if ($aptneuro == "Não") echo "selected"; ?> value="Não"> Não </option>
            </select>
        ...
        <div id="cid_203" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <select class="form-dropdown" id="input_203" name="ausenciasinais" style="width:150px;" data-component="dropdown">
              <option value=""> Selecione </option>
              <option <?php if ($ausenciasinais == "Sim") echo "selected"; ?> value="Sim"> Sim </option>
              <option <?php if ($ausenciasinais == "Não") echo "selected"; ?> value="Não"> Não </option>
            </select>
            <label class="form-label form-label-top" for="input_203" style="min-height:13px;"> Ausência de sinais e Sintomas clínicos </label>
          </span>
        </div>
      </li>
        ...
        <div id="cid_156" class="form-input jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_156_0" name="sifprimaria" <?php if ($sifprimaria == "Sim") echo "checked"; ?>  value="Sim" />
              <label id="label_input_156_0" style="font-size: 9px" for="input_156_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_156_1" name="sifprimaria"  <?php if ($sifprimaria == "Não") echo "checked"; ?>  value="Não" /> 
              <label id="label_input_156_1" style="font-size: 9px" for="input_156_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_206">
        <label class="form-label form-label-top" id="label_206" for="lite_mode_206"> Data da Dose unica </label>
        <div id="cid_206" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifprimaria_datadose" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_206" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="<?php echo $sifprimaria_datadose; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
        ...
        <div id="cid_209" class="form-input jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_209_0" name="sifsecundaria" <?php if ($sifsecundaria == "Sim") echo "checked"; ?> value="Sim" /> 
              <label id="label_input_209_0" style="font-size: 9px" for="input_209_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_209_1" name="sifsecundaria" <?php if ($sifsecundaria == "Não") echo "checked"; ?>  value="Não" />
              <label id="label_input_209_1" style="font-size: 9px" for="input_209_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_210">
        <label class="form-label form-label-top" id="label_210" for="lite_mode_210"> Data da 1° Dose </label>
        <div id="cid_210" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifsecundaria_datadose1" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_210" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="<?php echo $sifsecundaria_datadose1; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-4" data-type="control_datetime" id="id_216">
        <label class="form-label form-label-top" id="label_216" for="lite_mode_216"> Data da 2° Dose </label>
        <div id="cid_216" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifsecundaria_datadose2" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_216" style="font-size: 9px" type="date" size="12" data-maxlength="12" value="<?php echo $sifsecundaria_datadose2; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
        ...
        <div id="cid_215" class="form-input jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_215_0" name="sifterciaria" <?php if ($sifterciaria == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_215_0" style="font-size: 9px" for="input_215_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_215_1" name="sifterciaria"  <?php if ($sifterciaria == "Não") echo "checked"; ?>  value="Não" />
              <label id="label_input_215_1" style="font-size: 9px" for="input_215_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_217">
        <label class="form-label form-label-top" id="label_217" for="lite_mode_217"> Data da 1° Dose </label>
        <div id="cid_217" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
<div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifterciaria_datadose1" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_211" style="font-size: 9px" type="date" size="12" data-maxlength="12" value="<?php echo $sifterciaria_datadose1; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-4" data-type="control_datetime" id="id_211">
        <label class="form-label form-label-top" id="label_211" for="lite_mode_211"> Data da 2° Dose </label>
        <div id="cid_211" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifterciaria_datadose2" class="form-textbox validate[limitDate, validateLiteDate]" style="font-size: 9px" id="lite_mode_211" type="date" size="12" data-maxlength="12" value="<?php echo $sifterciaria_datadose2; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
              <label class="form-sub-label" for="lite_mode_211" id="sublabel_litemode" style="min-height:13px;">  </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top; width:15%;">
              <label class="form-sub-label" for="input_211_pick" style="min-height:13px;">  </label>
      ...
      <li class="form-line form-line-column form-col-5" data-type="control_datetime" id="id_218">
        <label class="form-label form-label-top" id="label_218" for="lite_mode_218"> Data da 3° Dose </label>
        <div id="cid_218" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifterciaria_datadose3" class="form-textbox validate[limitDate, validateLiteDate]" style="font-size: 9px" id="lite_mode_218" type="date" size="12" data-maxlength="12" value="<?php echo $sifterciaria_datadose3; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
       ...
       <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_243">
        ...
        <div id="cid_243" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="input_243" name="localdasdoses" data-type="input-textbox" class="form-textbox" size="20" value="<?php echo $localdasdoses; ?>" data-component="textbox" />
            <label class="form-label form-label-top" for="input_243" style="min-height:13px;"> Local das Doses Administradas </label>
          </span>
        </div>
      </li>

      <li class="form-line form-line-column form-col-6" data-type="control_radio" id="id_220">
        <label class="form-label form-label-top" id="label_220" for="input_220"> Tratamento Incompleto </label>
        <div id="cid_220" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_220_0" name="tratamentoincompleto" <?php if ($tratamentoincompleto == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_220_0" style="font-size: 9px" for="input_220_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_220_1" name="tratamentoincompleto" <?php if ($tratamentoincompleto == "Não") echo "checked"; ?> value="Não" />
              <label id="label_input_220_1" style="font-size: 9px" for="input_220_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-7" data-type="control_radio" id="id_221">
        <label class="form-label form-label-top" id="label_221" for="input_221"> Encaminhada para dessensibilização em unidade de Referência </label>
        <div id="cid_221" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_221_0" name="enc_dur" <?php if ($enc_dur == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_221_0" style="font-size: 9px" for="input_221_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_221_1" name="enc_dur" <?php if ($enc_dur == "Não") echo "checked"; ?>  value="Não" />
              <label id="label_input_221_1" style="font-size: 9px" for="input_221_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
        ...
        <div id="cid_224" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_224_0" name="gest_infectadapre" <?php if ($gest_infectadapre == "Sim") echo "checked"; ?>  value="Sim" />
              <label id="label_input_224_0" style="font-size: 9px" for="input_224_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_224_1" name="gest_infectadapre" <?php if ($gest_infectadapre == "Não") echo "checked"; ?> value="Não" />
              <label id="label_input_224_1" style="font-size: 9px" for="input_224_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
        ...
        <div id="cid_222" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_222_0" name="enc_compulsoria" <?php if ($enc_compulsoria == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_222_0" style="font-size: 9px" for="input_222_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_222_1" name="enc_compulsoria" <?php if ($enc_compulsoria == "Não") echo "checked"; ?> value="Não" />
              <label id="label_input_222_1" style="font-size: 9px" for="input_222_1"> Não </label>
            </span>
          </div>  
        </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_226">
        ...
        <div id="cid_226" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="enc_compulsoria_data" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_226" style="font-size: 9px" type="date" size="15" data-maxlength="15"  value="<?php echo $enc_compulsoria_data; ?>" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
        ...
        <div id="cid_223" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_223_0" name="gestalergica_penicilina" <?php if ($gestalergica_penicilina == "Sim") echo "checked"; ?> value="Sim" />
              <label id="label_input_223_0" style="font-size: 9px" for="input_223_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_223_1" name="gestalergica_penicilina" <?php if ($gestalergica_penicilina == "Não") echo "checked"; ?> value="Não" />
              <label id="label_input_223_1" style="font-size: 9px" for="input_223_1"> Não </label>
            </span>
          </div>
        </div>
      </li>
        ...
        <div id="cid_223" class="form-input-wide jf-required">
          <div class="form-single-column" data-component="radio">
            <span class="form-radio-item" style="clear:left;">
              ...
              <input type="radio" class="form-radio" id="input_223_0" name="reiniciouesquema" <?php if ($reiniciouesquema == "Sim") echo "checked=" ?> value="Sim" />
              <label id="label_input_223_0" style="font-size: 9px" for="input_223_0"> Sim </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="radio" class="form-radio" id="input_223_1" name="reiniciouesquema" <?php if ($reiniciouesquema == "Não") echo "checked"; ?> value="Não" />
      ...
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_dropdown" id="id_164">
        ...
        <div id="cid_164" class="form-input-wide jf-required">
          <select class="form-dropdown" id="input_164" name="parceirotratado" style="width:150px;" data-component="dropdown">
            <option value=""> Selecione </option>
            <option <?php if ($parceirotratado == "Sim") echo "selected"; ?> value="Sim"> Sim </option>
            <option <?php if ($parceirotratado == "Não") echo "selected"; ?> value="Não"> Não </option>
          </select>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_dropdown" id="id_229">
        ...
        <div id="cid_229" class="form-input-wide jf-required">
          <select class="form-dropdown" id="input_229" name="presc_outroesquema" style="width:150px;" data-component="dropdown">
            <option value=""> Selecione </option>
            <option <?php if ($presc_outroesquema == "Doxiciclina 100mg, VO, 2x ao dia por 15 dias") echo "selected";?> value="Doxiciclina 100mg, VO, 2x ao dia por 15 dias"> Doxiciclina 100mg, VO, 2x ao dia por 15 dias </option>
            <option <?php if ($presc_outroesquema == "Ceftriaxona 1g, IV ou IM, 1x por dia por 8 a 10 dias") echo "selected";?> value="Ceftriaxona 1g, IV ou IM, 1x por dia por 8 a 10 dias"> Ceftriaxona 1g, IV ou IM, 1x por dia por 8 a 10 dias </option>
      ...
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_dropdown" id="id_228">
        ...
        <div id="cid_228" class="form-input-wide jf-required">
          <select class="form-dropdown" id="input_228" name="presc_esquem_terapeutico" style="width:150px;" data-component="dropdown">
            <option value=""> Selecione </option>
              <option <?php if ($presc_esquem_terapeutico == "Primária") echo "selected"; ?> value="Primária"> Primária </option>
            <option <?php if ($presc_esquem_terapeutico == "Recente Secundária e latente") echo "selected"; ?> value="Recente Secundária e latente"> Recente Secundária e latente </option>
            <option <?php if ($presc_esquem_terapeutico == "Tardia (Latente e terciária)") echo "selected"; ?> value="Tardia (Latente e terciária)"> Tardia (Latente e terciária) </option>
          </select>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_dropdown" id="id_227">
        ...
        <div id="cid_227" class="form-input-wide jf-required">
          <select class="form-dropdown" id="input_227" name="motivo_naorealizado" style="width:150px;" data-component="dropdown">
            <option value=""> Selecione </option>
            <option <?php if ($motivo_naorealizado == "1. Parceiro não teve mais contato com a gestante ") echo "selected"; ?> value="1. Parceiro não teve mais contato com a gestante "> 1. Parceiro não teve mais contato com a gestante </option>
            <option <?php if ($motivo_naorealizado == "2. Parceiro não foi comunicado/convocado à UBS para tratamento") echo "selected"; ?> value="2. Parceiro não foi comunicado/convocado à UBS para tratamento" > 2. Parceiro não foi comunicado/convocado à UBS para tratamento </option>
            <option <?php if ($motivo_naorealizado == "3. Parceiro foi comunicado/convocado à US para tratamento mas não compareceu") echo "selected"; ?> value="3. Parceiro foi comunicado/convocado à US para tratamento mas não compareceu" > 3. Parceiro foi comunicado/convocado à US para tratamento mas não compareceu </option>
            <option <?php if ($motivo_naorealizado == "4. Parceiro foi comunicado/convocado à US mas recusou tratamento") echo "selected"; ?> value="4. Parceiro foi comunicado/convocado à US mas recusou tratamento"> 4. Parceiro foi comunicado/convocado à US mas recusou tratamento </option>
            <option <?php if ($motivo_naorealizado_outro == "5. Outros") echo "selected"; ?> value="5. Outros "> 5. Outros </option>
          </select>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_230">
        ...
        <div id="cid_230" class="form-input-wide jf-required">
          <input type="text" id="input_230" name="motivo_naorealizado_outro" data-type="input-textbox" class="form-textbox" value="<?php echo $motivo_naorealizado_outro ; ?>" data-component="textbox" />
        </div>
      </li>
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_dropdown" id="id_231">
        ...
        <div id="cid_231" class="form-input-wide jf-required">
          <select class="form-dropdown" id="input_231" name="desfecho" style="width:150px;" data-component="dropdown">
            <option value=""> Selecione </option>            
            <option <?php if ($desfecho == "Em Acompanhamento") echo "selected"; ?> value="Em Acompanhamento"> Em Acompanhamento </option>  
            <option <?php if ($desfecho == "Alta") echo "selected"; ?> value="Alta"> Alta </option>
            <option <?php if ($desfecho == "Aborto") echo "selected"; ?> value="Aborto"> Aborto </option>
            <option <?php if ($desfecho == "Natimorto") echo "selected"; ?> value="Natimorto"> Natimorto </option>
            <option <?php if ($desfecho == "Prematuridade") echo "selected"; ?> value="Prematuridade"> Prematuridade </option>
            <option <?php if ($desfecho == "Sinais Clínicos de Sífilis congênita") echo "selected"; ?> value="Sinais Clínicos de Sífilis congênita"> Sinais Clínicos de Sífilis congênita </option>
          </select>
        </div>
      </li>
      <li class="form-line" data-type="control_button" id="id_33">
        <div id="cid_33" class="form-input-wide">
          <div style="text-align:center;" class="form-buttons-wrapper">
            ...
            <button id="input_reset_33" type="button" class="form-submit-reset form-submit-button-simple_black" data-component="button" onclick="window.print()">
              Imprimir
            </button>
          </div>
        </div>
