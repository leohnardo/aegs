    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_237">
        ...
        <div id="cid_237" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_237" name="data_diag" type="date" style="font-size: 9px" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-2" data-type="control_datetime" id="id_236">
        ...
        <div id="cid_236" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="datainipre" id="lite_mode_236" type="date" style="font-size: 9px" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line" data-type="control_textbox" id="id_5">
        ...
        <div id="cid_5" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            ...
            <label class="fform-label form-label-top" for="input_5" style="min-height:13px;"> Nome da Gestante </label>
          </span>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_238">
        ...
        <div id="cid_238" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_nasc" id="lite_mode_238" style="font-size: 9px" type="date" size="12" data-maxlength="12" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_243">
        ...
        <div id="cid_244" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="text" id="complement" name="complemento" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" />
            <label class="" for="" style="min-height:13px;"> Complemento </label>
          </span>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_183">
        ...
        <div id="cid_183" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_dum" id="lite_mode_183" type="date" style="font-size: 9px" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-2" data-type="control_datetime" id="id_184">
        ...
        <div id="cid_184" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_dpp" id="lite_mode_184" type="date" style="font-size: 9px" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_185">
        ...
        <div id="cid_185" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input class="form-textbox validate[limitDate, validateLiteDate]" name="data_testerapido" id="lite_mode_185" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_189">
        ...
        <div id="cid_189" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="data_testetrepo" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_189" type="date" style="font-size: 9px" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_188">
        ...
        <div id="cid_188" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="data_presc1" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_188" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_117">
        ...
        <div id="cid_117" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            <input type="date" style="font-size: 9px" id="input_117" name="data_lab" data-type="input-textbox" class="form-textbox" size="15" value="" maxlength="15" placeholder=" " data-component="textbox" />
      ...
      <li class="form-line" data-type="control_radio" id="id_190">
        <label class="form-label form-label-top" id="label_190" for="input_190"> Realizado teste treponêmico (FT A - abs TPH A ou MHA TP Elisa) </label><br>
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_datetime" id="id_191">
        ...
        <div id="cid_191" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="data_testetrepo2" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_191" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-2" data-type="control_dropdown" id="id_201">
        ...
        <div id="cid_201" class="form-input-wide jf-required">
          <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
            ...
            <label class="form-label form-label-top" for="input_201" style="min-height:13px;"> Apresentações Neurológicas </label>
          </span>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_206">
        ...
        <div id="cid_206" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifprimaria_datadose" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_206" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_210">
        ...
        <div id="cid_210" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifsecundaria_datadose1" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_210"  style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-4" data-type="control_datetime" id="id_216">
        ...
        <div id="cid_216" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifsecundaria_datadose2" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_216" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
...
<div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifterciaria_datadose1" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_211" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-4" data-type="control_datetime" id="id_211">
        ...
        <div id="cid_211" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
           <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifterciaria_datadose2" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_211" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
              <label class="form-sub-label" for="lite_mode_211" id="sublabel_litemode" style="min-height:13px;">  </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top; width:15%;">
              <label class="form-sub-label" for="input_211_pick" style="min-height:13px;">  </label>
      ...
      <li class="form-line form-line-column form-col-5" data-type="control_datetime" id="id_218">
        ...
        <div id="cid_218" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="sifterciaria_datadose3" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_218" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="id_226">
        ...
        <div id="cid_226" class="form-input-wide jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top; width:75%;">
              <input name="enc_compulsoria_data" class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_226" style="font-size: 9px" type="date" size="15" data-maxlength="15" value="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
      ...
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_dropdown" id="id_231">
        <label class="form-label form-label-top"  style="position:center" id="label_231" for="input_231"> <h4 style="color:#000;" ><b>Desfecho </b> </h4></label>
